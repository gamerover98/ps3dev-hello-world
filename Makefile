...
#---------------------------------------------------------------------------------
#  TITLE, APPID, CONTENTID, ICON0 SFO.XML before ppu_rules.
#---------------------------------------------------------------------------------
TITLE		:=	Hello World
APPID		:=	TEST00001
...
#---------------------------------------------------------------------------------
LIBS		:=	-lcurl -lxml2 -lfont3d -ltiny3d -lsimdmath -lgcm_sys -lio -lsysutil -lrt -llv2 -lpngdec -lsysmodule -lm -lsysfs  -ljpgdec \
				-lnet -lfreetype -lz -lmikmod -laudio -lpolarssl -ljson-c -lnetctl
...
CFLAGS		=	-O2 -Wall -mcpu=cell -std=c++14 $(MACHDEP) $(INCLUDE)
CXXFLAGS	=	$(CFLAGS)
